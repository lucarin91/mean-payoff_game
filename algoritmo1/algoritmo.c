...
void algoritmo1(nodo *nodi[], int N, int f[]){
	...
	while (p!=NULL){
		...
		nodi[v]->f = (tmpI>Mg || tmpI<0) ? INT_MAX : tmpI;
...
int main(int argc, char *argv[]){	
	...
	if (argc>=4 && strstr(argv[1], "-")!=NULL && strstr(argv[1],"r")!=NULL){
		...
		printf("DEFAULT-mode! use -h for help!\n");
		N=6;	
		nodi = malloc(sizeof(nodo*)*N);
		//costruzione Grafo
		/*
		...
		*/
		...
		nodi[2]=newNodo(1);
		nodi[3]=newNodo(0);
		addSucc(0,1,-50,nodi,T);
		addSucc(1,0,0,nodi,T);
		addSucc(2,3,-1,nodi,T);
		addSucc(2,0,0,nodi,T);
		addSucc(3,2,0, nodi, T);
		*/
		...
		nodi[4]=newNodo(0);
		nodi[5]=newNodo(0);
		addSucc(0,0,-50,nodi,T);
		addSucc(1,2,-1,nodi,T);
		addSucc(1,3,-1,nodi,T);
		addSucc(2,1,0,nodi,T);
		addSucc(2,4,0,nodi,T);
		addSucc(3,2,-1,nodi,T);
		addSucc(3,0,0,nodi,T);
		addSucc(4,3,0,nodi,T);
		addSucc(4,5,-1,nodi,T);
		addSucc(5,5,1,nodi,T);
